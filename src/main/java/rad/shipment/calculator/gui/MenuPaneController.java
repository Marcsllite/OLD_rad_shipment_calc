...
public class MenuPaneController {
     ...
     */
    @FXML private void menuPaneHandler(ActionEvent event) throws InvalidParameterException {
    ...
    private void shipmentBtnHandler(){
        ...
        if(currentBtn == 0) logr.info(Main.replaceBundleString("usrMenuBtnClick", btnShipment.getText() , Integer.toString(++btnClicks)));
        else {
            setCurrentButton(btnShipment);  // setting the current button
            mainController.showHomePane();
        }
    }
    ...
    private void referenceBtnHandler(){
        // checking if user is already on the Shipment page
        if(currentBtn == 1) logr.info(Main.replaceBundleString("usrMenuBtnClick", btnReference.getText() , Integer.toString(++btnClicks)));
        else {
            setCurrentButton(btnReference);  // setting the current button
            mainController.showReferencePane();
        }
    }
     ...
     */
    private void setCurrentButton(Button btnCurrent) throws InvalidParameterException {
     ...
     */
    private void setButtonColor(Button btnMenu, String color) throws InvalidParameterException {
