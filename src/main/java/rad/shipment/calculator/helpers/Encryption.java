...
public class Encryption {
     ...
     */
    public byte[] encrypt(byte[] plainText, byte[] associatedData) throws InvalidParameterException {
        try {
     ...
     */
    public byte[] decrypt(byte[] cipherMessage, byte[] associatedData) throws IllegalArgumentException, SecurityException {
        try {
     ...
     */
    private static int charToInt(char hexChar) throws IllegalArgumentException {
