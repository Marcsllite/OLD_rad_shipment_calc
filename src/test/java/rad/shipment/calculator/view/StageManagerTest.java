...
public class StageManagerTest extends ApplicationTest {
    ...
    private final Exception properException = new Exception(Main.getString("properException"));
    ...
    public void logAndThrowException_NullMsg_NullException(){
        Platform.runLater(
            () -> {
                ...
                stageManager.logAndThrowException(null, null);
            }
        );
    }
    ...
    public void logAndThrowException_NullMsg_ProperException(){
        Platform.runLater(
            () -> {
                ...
                expectedException.expect(RuntimeException.class);
                expectedException.expectMessage(expectedMsg);
                stageManager.logAndThrowException(null, properException);
