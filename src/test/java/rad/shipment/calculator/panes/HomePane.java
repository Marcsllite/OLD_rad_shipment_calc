...
public class HomePane {
     ...
     */
    public Button getBtnAdd(){ return driver.find(BTN_ADD); }
     ...
     */
    public Button getBtnEdit(){ return driver.find(BTN_EDIT); }
     ...
     */
    public Button getBtnRemove(){ return driver.find(BTN_REMOVE); }
     ...
     */
    public TableView<Isotope> getTableView(){ return driver.find(TABLEVIEW); }
     ...
     */
    public Button getBtnCalculate(){ return driver.find(BTN_CALCULATE); }
}
