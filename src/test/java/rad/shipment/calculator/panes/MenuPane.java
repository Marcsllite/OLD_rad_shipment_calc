...
public class MenuPane {
    private static final Logger logr = Logger.getLogger(MenuPane.class.getName()); // matches the logger in the affected class
    private final MenuPaneControllerTest driver;
    private final String DEFAULT_BTN = BTN_SHIPMENT;
    ...
    public ImageView getImgViewColorLogo(){
        return driver.find(IMGVIEW_COLOR_LOGO); }
     ...
     */
    public ImageView getImgViewGreyLogo(){ return driver.find(IMGVIEW_GREY_LOGO); }
     ...
     */
    public Button getBtnShipment(){ return driver.find(BTN_SHIPMENT); }
     ...
     */
    public ImageView getImgViewShipment(){ return driver.find(IMGVIEW_SHIPMENT); }
     ...
     */
    public Button getBtnReference(){ return driver.find(BTN_REFERENCE); }
     ...
     */
    public ImageView getImgViewReference(){ return driver.find(IMGVIEW_REFERENCE); }
}
